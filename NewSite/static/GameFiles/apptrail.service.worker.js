...
/** @type {string} */
const CACHE_VERSION = '1775150218|1501760029';
/** @type {string} */
const CACHE_PREFIX = 'AppalachianTrail-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'apptrail.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["apptrail.html","apptrail.js","apptrail.offline.html","apptrail.audio.worklet.js","apptrail.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["apptrail.wasm","apptrail.pck","apptrail.side.wasm"];
