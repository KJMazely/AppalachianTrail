...
const STAT_CURVES: Dictionary[BuffableStats, Curve] = {
	BuffableStats.MAX_HEALTH: preload("res://resources/maxHealth_statCurve.tres"),
	BuffableStats.DEFENSE: preload("res://resources/defense_statCurve.tres"),
	BuffableStats.ATTACK: preload("res://resources/attack_statCurve.tres"),
}
